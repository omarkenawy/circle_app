...
export default function CardBody({ body, image, comments, postId }) {
    ...
    return <>
        ...
        {body && <p>{body}</p>}
        {image && <img className="w-full h-80 object-cover rounded-xl" src={image}></img>}
        <div className="w-full h-8 flex items-center px-3 my-3">
            ...
            <div className="w-full flex justify-between">
                ...
                <p className="ml-3 text-gray-500">{comments} comments</p>
            </div>
        </div>
        <div className="grid grid-cols-3 w-xl px-5 mx-auto my-3 ">
